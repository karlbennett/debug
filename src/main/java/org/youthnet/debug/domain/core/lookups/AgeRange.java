 ...
 */
@Entity
@DiscriminatorValue(value = "AgeRange")
public class AgeRange extends LookupBase implements java.io.Serializable {
    ...
    public AgeRange(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
