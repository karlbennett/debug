 ...
 */
@Entity
@DiscriminatorValue(value = "EmailType")
public class EmailType extends LookupBase implements java.io.Serializable {
    ...
    public EmailType(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
