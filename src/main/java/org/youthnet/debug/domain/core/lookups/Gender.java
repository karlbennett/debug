...
public class Gender extends LookupBase implements java.io.Serializable {
    ...
    public Gender(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
