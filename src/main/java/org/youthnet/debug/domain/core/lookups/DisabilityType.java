...
/**
 * DisabilityType generated by hbm2java
 */
@Entity
@DiscriminatorValue(value = "DisabilityType")
public class DisabilityType extends LookupBase implements java.io.Serializable {
    ...
    public DisabilityType(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
