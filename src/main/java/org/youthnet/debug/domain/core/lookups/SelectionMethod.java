...
/**
 * SelectionMethod generated by hbm2java
 */
@Entity
@DiscriminatorValue(value = "SelectionMethod")
public class SelectionMethod extends LookupBase implements java.io.Serializable {
    ...
    public SelectionMethod(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
