...
public class County extends LookupBase implements java.io.Serializable {
    ...
    public County(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
