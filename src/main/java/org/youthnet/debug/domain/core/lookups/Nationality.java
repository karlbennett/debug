 ...
 */
@Entity
@DiscriminatorValue(value = "Nationality")
public class Nationality extends LookupBase implements java.io.Serializable {
    ...
    public Nationality(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
