...
public class Religion extends LookupBase implements java.io.Serializable {
    ...
    public Religion(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
