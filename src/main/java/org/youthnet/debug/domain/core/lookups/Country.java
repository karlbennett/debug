...
public class Country extends LookupBase implements java.io.Serializable {
    ...
    public Country(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
