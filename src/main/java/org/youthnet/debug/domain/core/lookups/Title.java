...
public class Title extends LookupBase implements java.io.Serializable {
    ...
    public Title(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
