...
/**
 * OrganisationType generated by hbm2java
 */
@Entity
...
public class OrganisationType extends LookupBase implements java.io.Serializable {
    ...
    public OrganisationType(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
