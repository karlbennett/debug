...
/**
 * Suitabilities generated by hbm2java
 */
@Entity
@DiscriminatorValue(value = "Suitabilities")
public class Suitabilities extends LookupBase implements java.io.Serializable {
    ...
    public Suitabilities(Integer vBase2Id, UuidType languageId, String value, boolean isActive, Integer sortOrder, boolean isUserEditable, UuidType ownerId) {
